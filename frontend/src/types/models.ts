...
export type NodeConfigUpsertBySlugPayload = NonNullable<operations["nodeConfig.upsertBySlug"]["requestBody"]>["content"]["application/json"];
export type NodeConfigPreviewPayload = NonNullable<operations["nodeConfig.preview"]["requestBody"]>["content"]["application/json"];
