...
export default function Sessions() {
    ...
    return (
        <TooltipProvider>
            ...
            <div className="flex-1 flex flex-col min-h-0 bg-background text-foreground selection:bg-primary/10">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {otherSessions.filter((s) => s.status === "active")
                                ...
                                <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    className="h-8 gap-1.5 hidden sm:flex text-xs font-medium"
                                >
                                ...
                                <div className="bg-card border border-border/50 rounded-xl overflow-hidden shadow-sm">
                                    <div className="p-5 flex items-start justify-between gap-4 border-b border-border/40">
                                        ...
                                        <Button
                                            ...
                                            size="sm"
                                            onClick={() => logout()}
                                            className="h-8 gap-1.5 text-xs font-medium text-muted-foreground hover:text-red-500 hover:border-red-500/30"
                                        >
                                            <LogOut className="w-3.5 h-3.5" />
                                            Sign Out
                                        </Button>
