                ...
                <div className="bg-card/50 border border-border/50 rounded-xl p-4 shadow-sm">
                    ...
                    <PaginationControls
                        meta={{
                            mode: "page",
                            perPage: PAGE_SIZE,
                            hasPrevious: processPage > 1,
                            hasNext: processPage < processPageCount,
                        ...
                        onFirst={() => setProcessPage(1)}
                        onPrev={() => setProcessPage(Math.max(1, processPage - 1))}
                        onNext={() =>
                            setProcessPage(
                                Math.min(processPageCount, processPage + 1),
                            )
                        }
                        onLast={() => setProcessPage(processPageCount)}
                ...
                <div className="bg-card/50 border border-border/50 rounded-xl p-4 shadow-sm">
                    ...
                    <PaginationControls
                        meta={{
                            mode: "page",
                            perPage: PAGE_SIZE,
                            hasPrevious: portPage > 1,
                            hasNext: portPage < portPageCount,
                        ...
                        onFirst={() => setPortPage(1)}
                        onPrev={() => setPortPage(Math.max(1, portPage - 1))}
                        onNext={() =>
                            setPortPage(Math.min(portPageCount, portPage + 1))
                        }
                        onLast={() => setPortPage(portPageCount)}
                        onPage={setPortPage}
                    />
                </div>
            </div>
