...
export default function DocsGmailSmtp() {
    return (
        <PageLayout>
            <IndexHeader
                icon={Mail}
                ...
                trail={[{ label: "Docs" }, { label: "Gmail SMTP Setup" }]}
            />
            ...
            <main className="py-6 w-full flex-1">
                <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-10">
                    <Section title="How it works">
                        <p>
                            Secrets never live in the tracked <InlineCode>.env</InlineCode>.
                            The transport config lives in <InlineCode>.env</InlineCode>{" "}
                            ...
                            prefers injected env vars over <InlineCode>.env</InlineCode>{" "}
                            values.
                        </p>
...
MAIL_FROM_ADDRESS="you@gmail.com"`}</CodeBlock>
                        <p>
                            The tracked <InlineCode>.env</InlineCode> keeps the non-secret
