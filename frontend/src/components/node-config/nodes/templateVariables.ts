...
const LABELS: Record<TemplateVariableKey, { label: string; group: TemplateVariable['group']; description: string }> = {
    ...
    'server.is_assigned'            : { label: 'Is Assigned', group: 'server', description: 'Is Assigned (ServerData)' },
    ...
    'server.client.is_assigned'     : { label: 'Is Assigned', group: 'client', description: 'Is Assigned (ClientData)' },
