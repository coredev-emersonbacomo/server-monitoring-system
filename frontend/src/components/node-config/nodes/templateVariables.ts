...
const LABELS: Record<TemplateVariableKey, { label: string; group: TemplateVariable['group']; description: string }> = {
    ...
    'server.detach_linux_command'   : { label: 'Detach Linux Command', group: 'server', description: 'Detach Linux Command (ServerData)' },
    'server.detach_windows_command' : { label: 'Detach Windows Command', group: 'server', description: 'Detach Windows Command (ServerData)' },
    ...
    'server.subscription_fee'       : { label: 'Subscription Fee', group: 'server', description: 'Subscription Fee (ServerData)' },
    'server.agent_server_count'     : { label: 'Agent Server Count', group: 'server', description: 'Agent Server Count (ServerData)' },
    'server.is_assigned_to_current_user'            : { label: 'Assigned To Current User', group: 'server', description: 'Whether the server client is assigned to the current user (ServerData)' },
    ...
    'server.client.record_status'   : { label: 'Record Status', group: 'client', description: 'Record Status (ClientData)' },
    'server.client.budget'          : { label: 'Budget', group: 'client', description: 'Budget (ClientData)' },
    'server.client.total_subscription_fee': { label: 'Total Subscription Fee', group: 'client', description: 'Total Subscription Fee (ClientData)' },
    'server.client.is_assigned_to_current_user'     : { label: 'Assigned To Current User', group: 'client', description: 'Whether the client is assigned to the current user (ClientData)' },
    ...
    'metric.networks'               : { label: 'Networks', group: 'metric', description: 'Networks (StatPointData)' },
};
