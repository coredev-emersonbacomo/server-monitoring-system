...
const LABELS: Record<TemplateVariableKey, { label: string; group: TemplateVariable['group']; description: string }> = {
    ...
    'server.is_assigned_to_current_user': { label: 'Is Assigned To Current User', group: 'server', description: 'Is Assigned To Current User (ServerData)' },
    ...
    'server.client.is_assigned_to_current_user': { label: 'Is Assigned To Current User', group: 'client', description: 'Is Assigned To Current User (ClientData)' },
