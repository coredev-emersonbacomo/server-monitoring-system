...
\restrict Ndeez0OvNuGjaPPSVndXyJyTFWjMtmEx3XGjqxDXdah30mFWffnCkImwZbGj15w
...
--
-- Name: _direct_view_86; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_86 AS
...
--
-- Name: _direct_view_87; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_87 AS
...
--
-- Name: _direct_view_88; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_88 AS
...
--
-- Name: _direct_view_89; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_89 AS
...
--
-- Name: _direct_view_90; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_90 AS
...
--
-- Name: _direct_view_92; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_92 AS
 SELECT public.time_bucket('00:01:00'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
...
--
-- Name: _direct_view_93; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_93 AS
 SELECT public.time_bucket('01:00:00'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
    avg(rx_bytes) AS netin,
...
--
-- Name: _direct_view_94; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_94 AS
 SELECT public.time_bucket('1 day'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
    avg(rx_bytes) AS netin,
...
--
-- Name: _direct_view_95; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_95 AS
 SELECT public.time_bucket('7 days'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
    avg(rx_bytes) AS netin,
...
--
-- Name: _direct_view_96; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_96 AS
 SELECT public.time_bucket('1 mon'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
    avg(rx_bytes) AS netin,
...
--
-- Name: _materialized_hypertable_86; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_86 (
...
--
-- Name: _materialized_hypertable_87; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_87 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    cpu double precision,
    memory double precision,
...
--
-- Name: _materialized_hypertable_88; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_88 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    cpu double precision,
    memory double precision,
...
--
-- Name: _materialized_hypertable_89; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_89 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    cpu double precision,
    memory double precision,
...
--
-- Name: _materialized_hypertable_90; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_90 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    cpu double precision,
    memory double precision,
...
--
-- Name: _materialized_hypertable_92; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_92 (
    "timestamp" timestamp with time zone,
    server_id bigint,
...
--
-- Name: _materialized_hypertable_93; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_93 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    interface_name character varying(255),
    netin numeric,
...
--
-- Name: _materialized_hypertable_94; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_94 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    interface_name character varying(255),
    netin numeric,
...
--
-- Name: _materialized_hypertable_95; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_95 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    interface_name character varying(255),
    netin numeric,
...
--
-- Name: _materialized_hypertable_96; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_96 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    interface_name character varying(255),
    netin numeric,
...
--
-- Name: _partial_view_86; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_86 AS
 SELECT public.time_bucket('00:01:00'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
--
-- Name: _partial_view_87; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_87 AS
 SELECT public.time_bucket('01:00:00'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
--
-- Name: _partial_view_88; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_88 AS
 SELECT public.time_bucket('1 day'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
--
-- Name: _partial_view_89; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_89 AS
 SELECT public.time_bucket('7 days'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
--
-- Name: _partial_view_90; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_90 AS
 SELECT public.time_bucket('1 mon'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
--
-- Name: _partial_view_92; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_92 AS
 SELECT public.time_bucket('00:01:00'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
    avg(rx_bytes) AS netin,
...
--
-- Name: _partial_view_93; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_93 AS
 SELECT public.time_bucket('01:00:00'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
    avg(rx_bytes) AS netin,
...
--
-- Name: _partial_view_94; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_94 AS
 SELECT public.time_bucket('1 day'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
    avg(rx_bytes) AS netin,
...
--
-- Name: _partial_view_95; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_95 AS
 SELECT public.time_bucket('7 days'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
    avg(rx_bytes) AS netin,
...
--
-- Name: _partial_view_96; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_96 AS
 SELECT public.time_bucket('1 mon'::interval, created_at) AS "timestamp",
    server_id,
    interface_name,
    avg(rx_bytes) AS netin,
...
CREATE VIEW public.server_network_stats_agg_day AS
 SELECT _materialized_hypertable_94."timestamp",
    _materialized_hypertable_94.server_id,
    _materialized_hypertable_94.interface_name,
    _materialized_hypertable_94.netin,
    _materialized_hypertable_94.netout
   FROM _timescaledb_internal._materialized_hypertable_94
  WHERE (_materialized_hypertable_94."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(94)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('1 day'::interval, server_network_stats.created_at) AS "timestamp",
   ...
   FROM public.server_network_stats
  WHERE (server_network_stats.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(94)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_network_stats_agg_hour AS
 SELECT _materialized_hypertable_93."timestamp",
    _materialized_hypertable_93.server_id,
    _materialized_hypertable_93.interface_name,
    _materialized_hypertable_93.netin,
    _materialized_hypertable_93.netout
   FROM _timescaledb_internal._materialized_hypertable_93
  WHERE (_materialized_hypertable_93."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(93)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('01:00:00'::interval, server_network_stats.created_at) AS "timestamp",
    ...
    avg(server_network_stats.tx_bytes) AS netout
   FROM public.server_network_stats
  WHERE (server_network_stats.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(93)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_network_stats_agg_minute AS
 SELECT _materialized_hypertable_92."timestamp",
    _materialized_hypertable_92.server_id,
    _materialized_hypertable_92.interface_name,
    _materialized_hypertable_92.netin,
    _materialized_hypertable_92.netout
   FROM _timescaledb_internal._materialized_hypertable_92
  WHERE (_materialized_hypertable_92."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(92)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('00:01:00'::interval, server_network_stats.created_at) AS "timestamp",
    ...
    avg(server_network_stats.tx_bytes) AS netout
   FROM public.server_network_stats
  WHERE (server_network_stats.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(92)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_network_stats_agg_month AS
 SELECT _materialized_hypertable_96."timestamp",
    _materialized_hypertable_96.server_id,
    _materialized_hypertable_96.interface_name,
    _materialized_hypertable_96.netin,
    _materialized_hypertable_96.netout
   FROM _timescaledb_internal._materialized_hypertable_96
  WHERE (_materialized_hypertable_96."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(96)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('1 mon'::interval, server_network_stats.created_at) AS "timestamp",
    ...
    avg(server_network_stats.tx_bytes) AS netout
   FROM public.server_network_stats
  WHERE (server_network_stats.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(96)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_network_stats_agg_week AS
 SELECT _materialized_hypertable_95."timestamp",
    _materialized_hypertable_95.server_id,
    _materialized_hypertable_95.interface_name,
    _materialized_hypertable_95.netin,
    _materialized_hypertable_95.netout
   FROM _timescaledb_internal._materialized_hypertable_95
  WHERE (_materialized_hypertable_95."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(95)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('7 days'::interval, server_network_stats.created_at) AS "timestamp",
    ...
    avg(server_network_stats.tx_bytes) AS netout
   FROM public.server_network_stats
  WHERE (server_network_stats.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(95)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_updates_agg_day AS
 SELECT _materialized_hypertable_88."timestamp",
    _materialized_hypertable_88.server_id,
    _materialized_hypertable_88.cpu,
    _materialized_hypertable_88.memory,
    _materialized_hypertable_88.disk,
    _materialized_hypertable_88.netin,
    _materialized_hypertable_88.netout
   FROM _timescaledb_internal._materialized_hypertable_88
  WHERE (_materialized_hypertable_88."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(88)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('1 day'::interval, server_updates.created_at) AS "timestamp",
   ...
   FROM public.server_updates
  WHERE (server_updates.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(88)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_updates_agg_hour AS
 SELECT _materialized_hypertable_87."timestamp",
    _materialized_hypertable_87.server_id,
    _materialized_hypertable_87.cpu,
    _materialized_hypertable_87.memory,
    _materialized_hypertable_87.disk,
    _materialized_hypertable_87.netin,
    _materialized_hypertable_87.netout
   FROM _timescaledb_internal._materialized_hypertable_87
  WHERE (_materialized_hypertable_87."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(87)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('01:00:00'::interval, server_updates.created_at) AS "timestamp",
    ...
    avg(server_updates.network_tbytes) AS netout
   FROM public.server_updates
  WHERE (server_updates.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(87)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_updates_agg_minute AS
 SELECT _materialized_hypertable_86."timestamp",
    _materialized_hypertable_86.server_id,
    _materialized_hypertable_86.cpu,
    _materialized_hypertable_86.memory,
    _materialized_hypertable_86.disk,
    _materialized_hypertable_86.netin,
    _materialized_hypertable_86.netout
   FROM _timescaledb_internal._materialized_hypertable_86
  WHERE (_materialized_hypertable_86."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(86)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('00:01:00'::interval, server_updates.created_at) AS "timestamp",
    ...
    avg(server_updates.network_tbytes) AS netout
   FROM public.server_updates
  WHERE (server_updates.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(86)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_updates_agg_week AS
 SELECT "timestamp",
    ...
    netin,
    netout
   FROM _timescaledb_internal._materialized_hypertable_89;
...
--
-- Name: _materialized_hypertable_86_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_86_timestamp_idx ON _timescaledb_internal._materialized_hypertable_86 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_87_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_87_timestamp_idx ON _timescaledb_internal._materialized_hypertable_87 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_88_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_88_timestamp_idx ON _timescaledb_internal._materialized_hypertable_88 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_89_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_89_timestamp_idx ON _timescaledb_internal._materialized_hypertable_89 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_90_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_90_timestamp_idx ON _timescaledb_internal._materialized_hypertable_90 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_92_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_92_timestamp_idx ON _timescaledb_internal._materialized_hypertable_92 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_93_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_93_timestamp_idx ON _timescaledb_internal._materialized_hypertable_93 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_94_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_94_timestamp_idx ON _timescaledb_internal._materialized_hypertable_94 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_95_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_95_timestamp_idx ON _timescaledb_internal._materialized_hypertable_95 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_96_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_96_timestamp_idx ON _timescaledb_internal._materialized_hypertable_96 USING btree ("timestamp" DESC);
...
CREATE INDEX server_network_stats_agg_day_server_id_interface_name_timestamp ON _timescaledb_internal._materialized_hypertable_94 USING btree (server_id, interface_name, "timestamp");
...
CREATE INDEX server_network_stats_agg_hour_server_id_interface_name_timestam ON _timescaledb_internal._materialized_hypertable_93 USING btree (server_id, interface_name, "timestamp");
...
CREATE INDEX server_network_stats_agg_minute_server_id_interface_name_timest ON _timescaledb_internal._materialized_hypertable_92 USING btree (server_id, interface_name, "timestamp");
...
CREATE INDEX server_network_stats_agg_month_server_id_interface_name_timesta ON _timescaledb_internal._materialized_hypertable_96 USING btree (server_id, interface_name, "timestamp");
...
CREATE INDEX server_network_stats_agg_week_server_id_interface_name_timestam ON _timescaledb_internal._materialized_hypertable_95 USING btree (server_id, interface_name, "timestamp");
...
CREATE INDEX server_updates_agg_day_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_88 USING btree (server_id, "timestamp");
...
CREATE INDEX server_updates_agg_hour_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_87 USING btree (server_id, "timestamp");
...
CREATE INDEX server_updates_agg_minute_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_86 USING btree (server_id, "timestamp");
...
CREATE INDEX server_updates_agg_month_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_90 USING btree (server_id, "timestamp");
...
CREATE INDEX server_updates_agg_week_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_89 USING btree (server_id, "timestamp");
...
\unrestrict Ndeez0OvNuGjaPPSVndXyJyTFWjMtmEx3XGjqxDXdah30mFWffnCkImwZbGj15w

--
-- PostgreSQL database dump
--

\restrict Aa6yYHywRfQMhwq5Y6UkSIcpeePvvuTGg14LU0zhlLEjJg8uzzlYwyRDWfC07Ta
...
\unrestrict Aa6yYHywRfQMhwq5Y6UkSIcpeePvvuTGg14LU0zhlLEjJg8uzzlYwyRDWfC07Ta
