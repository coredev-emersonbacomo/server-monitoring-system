...
\restrict jYvkwjYVYGkohszgkNQF41rgeqKqljIrDAUIicMPaYj4tdRaskYh61wFkiQbIjs
...
--
-- Name: _compressed_hypertable_244; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._compressed_hypertable_244 (
);


--
-- Name: _compressed_hypertable_246; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._compressed_hypertable_246 (
);


--
-- Name: _compressed_hypertable_248; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._compressed_hypertable_248 (
);


--
-- Name: _compressed_hypertable_250; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._compressed_hypertable_250 (
);


--
-- Name: _compressed_hypertable_252; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._compressed_hypertable_252 (
);


--
-- Name: _compressed_hypertable_254; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._compressed_hypertable_254 (
);
...
--
-- Name: _direct_view_245; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_245 AS
...
--
-- Name: _direct_view_247; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_247 AS
...
--
-- Name: _direct_view_249; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_249 AS
...
--
-- Name: _direct_view_251; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_251 AS
...
--
-- Name: _direct_view_253; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._direct_view_253 AS
...
--
-- Name: _materialized_hypertable_245; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_245 (
...
--
-- Name: _materialized_hypertable_247; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_247 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    cpu double precision,
    memory double precision,
...
--
-- Name: _materialized_hypertable_249; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_249 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    cpu double precision,
    memory double precision,
...
--
-- Name: _materialized_hypertable_251; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_251 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    cpu double precision,
    memory double precision,
...
--
-- Name: _materialized_hypertable_253; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._materialized_hypertable_253 (
    "timestamp" timestamp with time zone,
    server_id bigint,
    cpu double precision,
    memory double precision,
...
--
-- Name: _partial_view_245; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_245 AS
 SELECT public.time_bucket('00:01:00'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
--
-- Name: _partial_view_247; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_247 AS
 SELECT public.time_bucket('01:00:00'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
--
-- Name: _partial_view_249; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_249 AS
 SELECT public.time_bucket('1 day'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
--
-- Name: _partial_view_251; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_251 AS
 SELECT public.time_bucket('7 days'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
--
-- Name: _partial_view_253; Type: VIEW; Schema: _timescaledb_internal; Owner: -
--

CREATE VIEW _timescaledb_internal._partial_view_253 AS
 SELECT public.time_bucket('1 mon'::interval, created_at) AS "timestamp",
    server_id,
    avg(cpu_usage) AS cpu,
    avg(memory_usage) AS memory,
...
CREATE VIEW public.server_updates_agg_day AS
 SELECT _materialized_hypertable_249."timestamp",
    _materialized_hypertable_249.server_id,
    _materialized_hypertable_249.cpu,
    _materialized_hypertable_249.memory,
    _materialized_hypertable_249.disk,
    _materialized_hypertable_249.netin,
    _materialized_hypertable_249.netout
   FROM _timescaledb_internal._materialized_hypertable_249
  WHERE (_materialized_hypertable_249."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(249)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('1 day'::interval, server_updates.created_at) AS "timestamp",
   ...
   FROM public.server_updates
  WHERE (server_updates.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(249)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_updates_agg_hour AS
 SELECT _materialized_hypertable_247."timestamp",
    _materialized_hypertable_247.server_id,
    _materialized_hypertable_247.cpu,
    _materialized_hypertable_247.memory,
    _materialized_hypertable_247.disk,
    _materialized_hypertable_247.netin,
    _materialized_hypertable_247.netout
   FROM _timescaledb_internal._materialized_hypertable_247
  WHERE (_materialized_hypertable_247."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(247)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('01:00:00'::interval, server_updates.created_at) AS "timestamp",
    ...
    avg(server_updates.network_tbytes) AS netout
   FROM public.server_updates
  WHERE (server_updates.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(247)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_updates_agg_minute AS
 SELECT _materialized_hypertable_245."timestamp",
    _materialized_hypertable_245.server_id,
    _materialized_hypertable_245.cpu,
    _materialized_hypertable_245.memory,
    _materialized_hypertable_245.disk,
    _materialized_hypertable_245.netin,
    _materialized_hypertable_245.netout
   FROM _timescaledb_internal._materialized_hypertable_245
  WHERE (_materialized_hypertable_245."timestamp" < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(245)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT public.time_bucket('00:01:00'::interval, server_updates.created_at) AS "timestamp",
    ...
    avg(server_updates.network_tbytes) AS netout
   FROM public.server_updates
  WHERE (server_updates.created_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(245)), '-infinity'::timestamp with time zone))
...
CREATE VIEW public.server_updates_agg_month AS
 SELECT "timestamp",
    ...
    netin,
    netout
   FROM _timescaledb_internal._materialized_hypertable_253;
...
CREATE VIEW public.server_updates_agg_week AS
 SELECT "timestamp",
    ...
    netin,
    netout
   FROM _timescaledb_internal._materialized_hypertable_251;
...
--
-- Name: _materialized_hypertable_245_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_245_timestamp_idx ON _timescaledb_internal._materialized_hypertable_245 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_247_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_247_timestamp_idx ON _timescaledb_internal._materialized_hypertable_247 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_249_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_249_timestamp_idx ON _timescaledb_internal._materialized_hypertable_249 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_251_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_251_timestamp_idx ON _timescaledb_internal._materialized_hypertable_251 USING btree ("timestamp" DESC);


--
-- Name: _materialized_hypertable_253_timestamp_idx; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _materialized_hypertable_253_timestamp_idx ON _timescaledb_internal._materialized_hypertable_253 USING btree ("timestamp" DESC);
...
CREATE INDEX server_updates_agg_day_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_249 USING btree (server_id, "timestamp");
...
CREATE INDEX server_updates_agg_hour_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_247 USING btree (server_id, "timestamp");
...
CREATE INDEX server_updates_agg_minute_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_245 USING btree (server_id, "timestamp");
...
CREATE INDEX server_updates_agg_month_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_253 USING btree (server_id, "timestamp");
...
CREATE INDEX server_updates_agg_week_server_id_timestamp_index ON _timescaledb_internal._materialized_hypertable_251 USING btree (server_id, "timestamp");
...
--
-- Name: agents_server_id_active_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX agents_server_id_active_unique ON public.agents USING btree (server_id) WHERE ((status)::text = 'active'::text);
...
\unrestrict jYvkwjYVYGkohszgkNQF41rgeqKqljIrDAUIicMPaYj4tdRaskYh61wFkiQbIjs

--
-- PostgreSQL database dump
--

\restrict HUgRN7yKwe7jlF2KzWBn9FZCkb199b0AOxySNYi8Z4ryaBwALwfA7h3oxG7xnui
...
\unrestrict HUgRN7yKwe7jlF2KzWBn9FZCkb199b0AOxySNYi8Z4ryaBwALwfA7h3oxG7xnui
